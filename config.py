...
class LoadConfig(object):
    def __init__(self, args, version):
        ...
        if args.dataset == 'product':
            ...
            #self.numcls = 0
            self.num_brands = 249 # 206 # 品牌数
            self.num_bmys = 3539 # 3421 # 年款数
        ...
        # 正式环境
        train_ds_file = 'bid_brand_train_ds_20200924.txt'
        val_ds_file = 'bid_brand_test_ds_20200924.txt'
        test_ds_file = 'bid_brand_test_ds_20200924.txt'
        '''
        # 精度测试
