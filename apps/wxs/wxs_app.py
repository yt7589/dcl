...
class WxsApp(object):
    ...
    RM_USE_WXS_BID_DS_AS_FTDS = 1037
    RM_TEMP001 = 10038
    ...
    def startup(self, args):
        ...
        elif WxsApp.RM_USE_WXS_BID_DS_AS_FTDS == mode:
            '''
            将无锡所测试集作为全量数据集测试集
            '''
            WxsDsm.use_wxs_bid_ds_as_ftds()
        elif WxsApp.RM_TEMP001 == mode:
            WxsDsm.temp001()
        else:
            WxsDsm.exp001()
