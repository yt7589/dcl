...
python train.py --data CUB --epoch 360 --backbone resnet50 \
                    ...
                    --crop 448 --cls_mul --swap_num 7 7 --auto_resume

(pytorch1.1) zjkj@zjkj01:~/working_zjw/DCL_NET_II/DCL-master-carsc$ python train.py --data CUB --epoch 360 --backbone resnet50 --tb 32 --tnw 16 --vb 512 --vnw 16 --lr 0.0008 --lr_step 60  --cls_lr_ratio 10 --start_epoch 0  $LAST_EPOCH --detail training_descibe4checkpoint --size 512 --crop 448 --cls_mul --swap_num 7 7 --auto_resume
