...
void runTensorRT()
{
    ...
    profile->setDimensions("data", nvinfer1::OptProfileSelector::kMIN, Dims3(3,224,224);
    profile->setDimensions("data", nvinfer1::OptProfileSelector::kOPT, Dims3(3,224,224);
    profile->setDimensions("data", nvinfer1::OptProfileSelector::kMAX, Dims3(3,224,224);
