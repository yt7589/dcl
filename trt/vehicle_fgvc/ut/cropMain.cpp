...
std::vector<cv::Mat> getinputimg(int num)
{
    ...
    for (int i = 0; i < num; ++i)
    { 
        paths.push_back("/media/zjkj/35196947-b671-441e-9631-6245942d671b/yantao/fgvc/dcl/trt/vehicle_fgvc/ut/4354.jpg");
    }
...
void *mythread(void *threadid)
{
    ...
    std::string modelfile = "/media/zjkj/35196947-b671-441e-9631-6245942d671b/"
                            "yantao/fgvc/dcl/trt/vehicle_fgvc/models/dcl_yt3.trt";
