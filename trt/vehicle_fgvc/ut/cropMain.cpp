...
void runTensorRT()
{
    ...
    profile->setDimensions("data", nvinfer1::OptProfileSelector::kMIN, nvinfer1::Dims4(3,224,224));
    profile->setDimensions("data", nvinfer1::OptProfileSelector::kOPT, nvinfer1::Dims4(3,224,224));
    profile->setDimensions("data", nvinfer1::OptProfileSelector::kMAX, nvinfer1::Dims4(3,224,224));
